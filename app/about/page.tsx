  ...
  return (
    <main className="max-w-3xl mx-auto px-4 py-16 text-sm leading-relaxed">
      ...
      <section className="mb-8">
        <p className="text-base leading-7">AI compliance scanner — automatically check websites and documents for regulatory compliance.</p>
      </section>

      <section className="mb-8">
        <h2 className="text-lg font-semibold mb-3">What We Offer</h2>
        <p>
          ComplyBuddy is a free service built to make productivity more accessible through the power of artificial intelligence.
