...
export const metadata: Metadata = {
  title: "Privacy Policy | ComplyBuddy",
  description: "Privacy policy for ComplyBuddy — how we collect, use and protect your data.",
  ...
  return (
    <main className="max-w-3xl mx-auto px-4 py-16 text-sm leading-relaxed">
      ...
      <Section title="1. Who We Are">
        <p>ComplyBuddy (https://complyscan.app) is operated by an independent developer. AI compliance scanner — automatically check websites and documents for regulatory compliance.</p>
