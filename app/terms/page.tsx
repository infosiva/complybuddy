...
export const metadata: Metadata = {
  title: "Terms of Service | ComplyBuddy",
  description: "Terms of service for ComplyBuddy — your rights and responsibilities when using our service.",
  ...
  return (
    <main className="max-w-3xl mx-auto px-4 py-16 text-sm leading-relaxed">
      ...
      <Section title="1. Acceptance of Terms">
        <p>
          By accessing or using ComplyBuddy (https://complyscan.app), you agree to be bound by these Terms of Service.
          If you do not agree, please do not use the service.
        </p>
      </Section>

      <Section title="2. Description of Service">
        <p>AI compliance scanner — automatically check websites and documents for regulatory compliance.</p>
        <p className="mt-2">
      ...
      <Section title="5. Intellectual Property">
        <p>
          All original content, design and code on this service is owned by or licensed to ComplyBuddy.
      ...
      <Section title="9. Limitation of Liability">
        <p>
          To the fullest extent permitted by law, ComplyBuddy shall not be liable for any indirect,
